...
('MearOne', 'YzmUabO0yfOwJHgDAhMIeUYwAvi1', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsPOjdZEFuf0XsPl9nBVP4MHlgdRdrH6hbdw&usqp=CAU', 'Visionary', 'Mear One is an American artist based in Los Angeles, known for his often-political street graffiti art.', 12345678, 'NY,USA', false, true),
...
('Przemek Pyszczek','8', 'https://dcxvepib5r3t6.cloudfront.net/attachments/file_s3s/5d07/bf0e/56b5/e400/08af/4272/original/0-Portrait.jpg?1560788749', 'Architecture', 'Przemek Pyszczek draws upon his training in architecture and his personal history for his cerebral, understated sculptures, installations, and paintings. Born in Poland, he moved to Canada with his family, only returning to his birthplace a handful of times while growing up.', 12345678, 'Canada', false, true);

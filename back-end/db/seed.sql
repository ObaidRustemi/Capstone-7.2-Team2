...
('Frankie','LydaEG5k94TfDmT9KIKAhdzG9Tx2', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkuhfsoNiO7xvIPlUm9F6YlSkbg5TIMKPzsQ&usqp=CAU', 'Romanticism', 'Romanticism is a genre of art which was originated in Europe somewhere in the 18th century against the Age of Enlightenment. Romanticism was an artistic and intellectual movement which is describes by an elevated interest in nature, importance given to the individual’s expression of thoughts and feelings, and to reject the norms of classicism', 12345678, 'USA', false, true),
('Mike', 'ZE6t5nOcxwMMhFxtaanEMBSWlYn2', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkBjPgf2fnrs1xijdTGBEqIVggPnTInj9EPQ&usqp=CAU', 'Art Nouveau', 'Art Nouveau is a term which is derived from French language which literally means new art’. This genre of art developed in France from where it extended to different European countries such as Belgium, Germany, Italy, etc.', 12345678, 'USA', true, false), 
('Sam','SItsbxhHWLTDxvQ1wrQQwnSlnES2', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7Zs0Xktv98InMPo4XQUeL6IK8BvsqkSnYgw&usqp=CAU', 'Expressionism', 'Expressionism is a genre of art which deals with the subjective feelings of an artist. This genre of art flourished in the 20th century in a response to the impressionism. The main purpose of expressionism is to depict emotions by means of art.', 12345678, 'Paterson, NJ', true, false),
('Rocio Marie Cabrera','x8CeahIL7jaZ3rENptL7d9mY6t52', 'https://images.squarespace-cdn.com/content/v1/567f25e4a976af5d461070fe/1497822525271-6V7XYSC6I1JY1TLV37HV/image-asset.jpeg?format=750w', 'Surreal Pop Art', 'Painter and sculptor from the Bronx', 333-444-7777, 'Bronx, NY', false, true),
('Annie Legnini','Ua9dUh7IkOQnumORXggQ97IAyis2', 'https://pkimgcdn.peekyou.com/a55e9e1eed3b4cf82c7ff658596eb0d0.jpeg', 'Collage & Mixed Media', 'Creator of Bronx Faces', 444-555-888, 'Bronx, NY', false, true),
('Monica Hernandez','fjmPsFY8jvPFLX9DsFFQjiiZYVh2', 'https://static.wixstatic.com/media/5d56fa_ed32fca8fa2e4f9ea3c81b1eaa74f55a~mv2.jpg/v1/fill/w_429,h_536,al_c,q_90/IMG_8680.webp', 'Oil Paint & Canvas', 'First Generation Dominican Artist', 444-555-888, 'Bronx, NY', false, true),
('Fred Emmanuel', 'SSQmKH488PUYED1oJe0MPKidPaE2', 'https://i.imgur.com/5OjHAg1.jpg', 'Pop Art', 'Fred Emmanuelle, known professionally as just FredEE, is an American artist and designer', 123-456-7877, 'Rochester, NY', false, true),
('Mike Mitchell', 'C8QFbExthBMvPkGZ2CtM13bcWoi1', 'https://geekxlovin.files.wordpress.com/2014/05/this-one-3.jpg', 'Surrealism', 'Mike Mitchell is an American artist known for his pop surrealism', 123-456-7899, 'Los Angeles, CA', false, true),
('Jonathan Solter', 'lLRNjT58uVQkDPagXaBW1HMdGRk1', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe0ikHZj4pxQ3LJ6Q06deAfajXXNJ4dg0X0w&usqp=CAUP', 'Visionary Art', 'Jonathan Solter is an artist living and working in the Bay Area. Growing up in the redwood forests of Northern California, he started making art at an early age with the loving support of his family. This began with mazes and labyrinths, leading to the creation of new worlds from both his imagination and the natural environment; and turning more towards Psychedelic art after high school', 917-123-4567, 'Oakland, CA', false, true),
('Alex Polanco', 'wD7INEdpccYJr5ilh2GVGPDZicq2', 'http://alexpolancoart.com/images/IMG_2433.jpg', 'Visionary Art', 'Taino artist, born in Kiskeya (Dominican Republic)', 347-265-5122 , 'New York, NY', false, true);

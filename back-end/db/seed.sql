...
('Kaws', null, 'https://www.christies.com/media-library/images/features/articles/2019/03/19/10-things-to-know-about-kaws/kaws_briandonnelly_by_hye-ryoungmin-hero-880i.jpg', 'Pop Art', 'Brian Donnelly, known professionally as Kaws, is an American artist and designer.', 12345678, 'NY,USA', false, true),
('Takashi Murakami',null, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS67Y4gvW3UQbpAWcTafjzigvRjy_7pDj0YTA&usqp=CAU', 'Contemporary', 'Takashi Murakami is a Japanese contemporary artist. He works in fine arts media as well as commercial and is known for blurring the line between high and low arts.', 12345678, 'Tokyo, Japan', false, true),
...
('The Paper Box', 'http://thepaperbox.nyc/wp-content/uploads/2016/02/IMG_3348-950x713.jpg', 6, 'The Paper Box is an independently owned music and arts complex in East Williamsburg, Brooklyn. We value artistic expression in all its forms and have hosted a multitude of events since Summer 2012, including live music shows, DJ parties, theater performances, and label showcases. We’ve also hosted many private events including; weddings, bar mitzvahs corporate events, and baby showers. We are a licensed venue with a full bar and certificate of public assembly and Insurance.' ,'17 Meadow St. Brooklyn, NY 11206'),
('Bogart House', 'https://i.ticketweb.com//i/venue/436405_Venue.jpg?v=2', 7, 'Multiple spaces, indoor space and outdoor rooftop, Funktion-One Sound System, Full Bar, Speakeasy Vibes','230 Bogart St, Brooklyn, NY 11206');
